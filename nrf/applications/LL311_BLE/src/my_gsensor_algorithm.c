...
static const float s_model_mean[NUM_MODES][FEATURE_DIM] = {
    { 0.018064f, 0.020704f, 0.032160f, 1.078125f, 0.176226f, 0.748460f, 0.002586f, 0.001420f },  /* STILL */
    { 0.053458f, 0.060820f, 0.187283f, 1.777344f, 0.065099f, 0.851634f, 0.000950f, 0.001224f },  /* LAND */
    { 0.053758f, 0.058734f, 0.144318f, 3.147321f, 0.050959f, 0.889216f, 0.001053f, 0.000955f },  /* SEA */
};

static const float s_model_std[NUM_MODES][FEATURE_DIM] = {
    { 0.001555f, 0.001689f, 0.004790f, 1.921875f, 0.049942f, 0.034314f, 0.000345f, 0.000526f },  /* STILL */
    { 0.006082f, 0.007860f, 0.031833f, 1.795707f, 0.026909f, 0.037472f, 0.000158f, 0.000381f },  /* LAND */
    { 0.012172f, 0.012965f, 0.033060f, 2.059900f, 0.017433f, 0.025406f, 0.000241f, 0.000259f },  /* SEA */
};
...
gsensor_state_t sm_update(state_machine_t *sm, const float raw_prob[NUM_MODES])
{
    ...
    { /* 如果检测到模式变化 */
        ...
        {                          /* 如果与候选模式一致 */
            ...
            if (sm->candidate_count >= gConfigParam.motdet_config.motdet_transition_count)
            {                                /* 达到确认次数 */
